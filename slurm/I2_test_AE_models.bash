...
for iteration in {1..10}; do
    ...
    #     --test \
    #     --load_model_path models/I_AE_models/I_AE_model03_QR_${iteration}.pth \
    ...
    python src/I_AE_maxillofacial.py --pred_method CQR --confidence 0.95 \
        --calibrate --test \
        --load_model_path models/I_AE_models/I_AE_model04_CQR_${iteration}.pth \
