...
for iteration in {1..1}; do
    ...
    python src/AMSC_maxillofacial.py --pred_model_type base \
        --train --test \
        --load_model_path models/AMM_model02_base.pth \
    ...
    python src/AMSC_maxillofacial.py --pred_model_type RAPS --confidence 0.9 \
        --calibrate --test \
        --load_model_path models/AMSC_model02_LAC.pth \
        --save_model_path models/AMSC_model05_APS.pth \
