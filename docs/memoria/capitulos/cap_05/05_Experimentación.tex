...
\begin{table}[htbp]
    ...
    \begin{tabular}{cccccc}
    \toprule
    \multirow{2}{*}{\textbf{\begin{tabular}[c]{@{}c@{}}Amplitud del \\[-0.8ex] intervalo\end{tabular}}} &  & \multicolumn{4}{c}{\textbf{Cobertura Empírica (\%)}} \\ \cline{3-6} 
    &  & \textbf{base} & \textbf{ICP} & \textbf{QR} & \textbf{CQR} \\ \hline
    $[3.0 , 3.5)$ &  & --    & --    & 91.97 & -- \\
    $[3.5 , 4.0)$ &  & --    & --    & 92.89 & -- \\
    $[4.0 , 4.5)$ &  & --    & --    & 88.18 & 100 \\
    ...
    \caption[
        ...
        Cobertura empírica del intervalo de predicción obtenida por cada método de predicción para distintas franjas de amplitud de intervalos. Nota: Estos cálculos se han realizado sobre todas las instancias predichas para cada método en las 10 ejecuciones o entrenamientos realizados. Cabe recordar que la cobertura objetivo es del 95\%. 
    }
