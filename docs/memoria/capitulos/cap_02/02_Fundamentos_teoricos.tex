...
\section{Error e incertidumbre}

La metrología\footnote{
    Ciencia de las mediciones y sus aplicaciones \cite{jcgm200:2012es}.
}, y la estadística comparten un papel fundamental en el análisis del 
error y la incertidumbre en campos como el ML. La metrología proporciona el marco para entender y cuantificar 
con precisión las mediciones, mientras que la estadística permite modelar, analizar y gestionar la 
variabilidad inherente a los datos.
...
que caracteriza la dispersión de los valores que podrían atribuirse razonablemente al mesurando\footnote{
    El mesurando es la magnitud a ser medida. 
}. [...] El parámetro puede ser, por ejemplo, una desviación estándar, o la anchura de un intervalo con un 
nivel de confianza establecido'' \cite{jcgm100:2008}.

Partiendo de estas definiciones generales, veamos ...

%-------------------------------------------------------------------------------------------------------------

El enfoque basado en el error parte del supuesto de que existe un valor verdadero. En consecuencia, el 
propósito de la medición es aproximarse lo más posible a dicho valor, minimizando las distintas componentes 
del error \cite{jcgm100:2008}:
...
como significativos, de modeo que la esperanza matemática del error sistemático sea igual a cero.

Es en esta asunción donde reside su mayor debilidad, pues aquellos efectos sistemáticos no identificados o
cuantificables dificultan su diferenciación de los efectos aleatorios. 

%-------------------------------------------------------------------------------------------------------------

Frente a este enfoque, se presenta el \textbf{enfoque en la incertidumbre}


, que asume la imposibilidad de 
conocer exactamente el valor verdadero del mensurado



asignar un intervalo de valores razonables al mensurado

información adicional puede reducir el rango de valores del intervalo



la medición puede entenderse como una forma de determinar el error del instrumento
en ensayo
...
Se diferencian dos enfoques estadísticos: estadística frecuentista y estadística bayesiana.

La \textbf{estadística frecuentista} 
