...
Este proceso se repite al desplazar el filtro por toda la imagen, generando un \textbf{mapa de activación},
...
% No obstante, 
% aumentar el tamaño de los filtros presenta desventajas: incrementa considerablemente el número de parámetros 
% y, por tanto, también aumenta el coste computacional y puede llevar al sobreajuste del modelo, que con más 
% parámetros puede memorizar mejor los datos de entrenamiento. 
% En lugar de esto, se recurre a técnicas de submuestreo (\textit{downsampling}), que pemitan resumir la
% información más relevante (desde el punto de vista de resolución del problema) de la imagen en menos espacio.
...
% reducen la dimensionalidad de las 
% imágenes (resumiendo grupos de píxeles en uno solo) sin perder información relevante.

% Al reducirse el tamaño espacial (ancho y alto) de la imagen, disminuye la cantidad de parámetros y cálculos
% en las capas posteriores, ayudando a controlar el coste computacional y a evitar el sobreajuste.
