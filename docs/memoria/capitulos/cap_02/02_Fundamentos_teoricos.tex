...
\begin{itemize}
    ...
    Estocástico (SGD) puro\cite{bottou2010}---, estas se suelen entrenar por lotes (\textit{batches}) debido a     % En muchos sitios se denominan mini-batches a los lotes, pero no entiendo la diferencia con batches
