...
Bajo las garantías estadísticas que ofrece el marco teórico de la CP, esta muestra un gran potencial en su
flexibilidad para ser integrada con otros métodos UQ. 
\todo{Esto llevarlo al final del apartado o a estado del arte}
...
\todo{No sé si este apartado es mejor introducirlo en Materiales y métodos, o directamente borrarlo, ya que
en Materiales y métodos se explica cada una de las técnicas específicas. Pero se me hace raro que no 
haya ninguna alusión al proceso de calibración e inferencia conformal en Fundamentos Teóricos.}
...
\todo{Debería introducir una imagen sobre intuición de heterocedasticidad aquí?}
...
Una vez se ha realizado la calibración y, por tanto, tenemos el umbral de no conformidad, podemos realizar
...
\begin{enumerate}
    ...
    \todo{Pie de página demasiado largo y no sé si necesario. Tal vez podría introducirlo en una imagen 
    esquemática del proceso. ¿Qué opina?}
