...
\begin{figure}[h]
    ...
    \caption[
        ...
        %
        Con la CP se busca que predicciones no solo proporcionen una etiqueta puntual, sino un conjunto de posibles etiquetas que capture de manera robusta la incertidumbre asociada al ejemplo de entrada.
    } 
...
Existen multitud de técnicas de CP. Generalmente, estas dependen del tipo de problema a resolver: regresión \cite{papadopoulos2002, romano2019, bethell2024}, clasificación \cite{sadinle2019, romano2020, angelopoulos2020}, series temporales \cite{xu2021, zaffran2022, stankeviciute2021}%
\footnote{
...
\begin{enumerate}
    ...
    Bajo las garantías estadísticas que ofrece el marco teórico de la CP, esta flexibilidad muestra un gran potencial para ser integrada con otras técnicas de UQ, ampliando así sus aplicaciones y mejorando la robustez de las estimaciones de incertidumbre.
