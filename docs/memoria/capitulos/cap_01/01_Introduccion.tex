...
% Utilizar la siguiente cita:
% [Beauthier09] Beauthier JP, De Valck E, Lefevre P, De Winne J (2009). Mass Disaster Victim Identification: The Tsunami Experience. The Open Forensic Sci J 2:54-62.
...
el individuo es excluido como posible coincidencia \cite{byers2023}. %cap18 
...
\begin{itemize}
    ...
    % Prueba de concepto, primer aproximacioón a un marco interpretable ...

    %\item (Demasiado ambicioso tal vez) Desarrollar un marco interpretable para la toma de decisiones en antropología 
    %forense, donde la incertidumbre cuantificada pueda integrarse en informes periciales bajo estándares jurídicos.  
