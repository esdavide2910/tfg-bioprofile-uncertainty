...
El primero consiste en tomar un método clásico de \acrshort{AF} y automatizar sus etapas mediante herramientas computacionales. Para ello, el método debe definir:
