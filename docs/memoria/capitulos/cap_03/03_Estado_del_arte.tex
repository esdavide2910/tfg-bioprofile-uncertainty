...
Sin embargo, cuando la estimación de edad se realiza en personas vivas, no se tiene acceso a sus huesos de 
forma directa.
...
\todo{No encuentro los documentos concretos en los que se dan recomendaciones, porque las referencias que he 
visto están obsoletas}
...
\todo{Introduzco en este apartado alguna figura? La Figura 1 de \cite{schmeling2016} podría estar bien, pero 
tal vez requiere de demasiada explicación. Abierto a otras sugerencias.}
...
\todo{Explicar qué es BAR1, BAR2 y CA}
\todo{Recomendado pasarlo a tabla}

\todo{Incluir información de Javier Venema} 


% \begin{itemize}

%     \item La media del error absoluto medio $\pm$ desviación estándar: Esta métrica cuantifica el error 
%     absoluto promedio entre la edad cronológica y la edad fisiológica predicha, proporcionando una medida 
...
%     \item Gráficos de dispersión de edad cronológica vs edad fisiológica: Permiten visualizar la relación 
...
% Sin embargo, ...
% existe variabilidad inherente en la correspondencia entre edad fisiológica y cronológica, porque dos personas
% con la misma edad cronológica pueden presentar edades fisiológicas significativamente diferentes 
